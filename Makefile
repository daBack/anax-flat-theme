...
# LESS and CSS
LESS 		 	= style.less modules.less vgrid.less base.less light.less color.less dark.less colorful.less typography-theme.less fun.less pattern1.less pattern2.less pattern3.less compTheme1.less compTheme2.less compTheme3.less
...
upgrade-grid:
	@$(call HELPTEXT,$@)
	wget --quiet https://raw.githubusercontent.com/dbwebb-se/design/master/example/grid/fluid/less/grid-flex.less
	wget --quiet https://raw.githubusercontent.com/dbwebb-se/design/master/example/grid/fluid/less/grid-float.less
